...
Hi, my name is Patrick Skiba and I'm a software developer living in West Hartford, CT. 

You can find me on [Github](https://github.com/patrickskiba) or you can write me an email at [pskiba@posteo.net](mailto:pskiba@posteo.net).
...
<img class="pete" src="/assets/images/pete.jpg" alt="Pete my Cat" />

## What Powers This Site

This site is generated by [Jekyll](https://jekyllrb.com/); I use the default [minima](https://github.com/jekyll/minima) theme, with no modifications because customization is a sin. Hosting is provided by [Firebase](https://firebase.google.com/). 
